...
def run(data,
    ...
    for batch_i, (im, targets, paths, shapes) in enumerate(pbar):
        ...
        # Loss
        if compute_loss:
            # loss += compute_loss([x.float() for x in train_out], targets, im)[1]
...
def parse_opt():
    ...
    parser.add_argument('--data', type=str, default=ROOT / 'data/MAR20.yaml', help='dataset.yaml path')
    parser.add_argument('--weights', nargs='+', type=str, default=ROOT / 'train/baseline/fair1m60/weights/last.pt', help='model.pt path(s)')
